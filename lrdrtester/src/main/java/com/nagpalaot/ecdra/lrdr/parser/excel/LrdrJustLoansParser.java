...
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.HEADING_FIRST_CRITERIA;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.HEADING_HEADER_CRITERIA;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.HEADING_LOAN_CRITERIA;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.HEADING_TRAILER_CRITERIA;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_ACAD_LEVEL;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_AMOUNT;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_CLAIM_REASON;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_CLASS_BEGIN;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_CLASS_END;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_CONSOL_INDICATOR;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_CONSOL_NSLDS_ID;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_CURRENT_LENDER;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_DEFAULT_DATE;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_DOB;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_ENROLLMENT;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_ENROLLMENT_DATE;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_FIRST_NAME;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_GUARANTOR;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_GUARANTY_DATE;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_LAST_NAME;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_LOAN_IDENTIFIER;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_LOAN_STATUS;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_LOAN_STATUS_DATE;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_LOAN_TYPE;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_MID_NAME;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_ORIG_GUARANTOR;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_ORIG_LENDER;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_ORIG_SCHOOL;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_RECORD_TYPE;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_REPAY_DATE;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_SSN;
import static com.nagpalaot.ecdra.lrdr.parser.excel.LrdrParser.POS_USAGE1;
...
public class LrdrJustLoansParser {
	...
	public List<LrdrLoanRecord> parseLrdrLoanData(Sheet sheet, Lrdr lrdr) throws ParseException{
	...
	/**
	 * LRDR dates in the Excel file should be in data format but they might also be in text.
	 * Check which type before reading
	 * 
	 * @return
		...
		if(cell != null){
			...
			if(CellType.BLANK != cell.getCellType()){
				if(CellType.NUMERIC == cell.getCellType()){
					Double tempResult = cell.getNumericCellValue();
					result = Integer.toString(tempResult.intValue());
				}
