...
public abstract class LrdrParser {
	...
	public List<LrdrLoanRecord> parseLrdrData(Sheet sheet) throws ParseException, IOException{
		List<LrdrLoanRecord> result = performParsing(sheet);
		return result;
	}
	
	protected abstract List<LrdrLoanRecord> performParsing(Sheet sheet) throws ParseException, IOException;
